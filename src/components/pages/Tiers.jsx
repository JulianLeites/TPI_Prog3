  ...
  const suscriptionTiers = [
    {
      ...
      color: "#824621",
      imageUrl:
        "https://imgs.search.brave.com/xqYNsWqv3a2QWtWr6GY3JrKAeEvKY_M3x4E_ABF8G18/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMudmVjdGVlenku/Y29tL3N5c3RlbS9y/ZXNvdXJjZXMvdGh1/bWJuYWlscy8wNzMv/MDc2LzcxNi9zbWFs/bC8zZC1icm9uemUt/bWVkYWwtc3Rhci1h/d2FyZC1pY29uLXBu/Zy5wbmc",
    },
    {
      id: 2,
      name: "Silver",
        ...
        {suscriptionTiers.map((tier) => (
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text>{tier.quota}</Card.Text>
              <Button variant="primary" onClick={() => handleSuscript(tier)}>
                Suscribirse
              </Button>
            </Card.Body>
          </Card>
