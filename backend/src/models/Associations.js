...
User.belongsToMany(Membership, { through: User_Membership, foreignKey: 'user_id' });
Class.belongsToMany(User, { through: User_Class, foreignKey: 'class_id' });
Membership.belongsToMany(User, { through: User_Membership, foreignKey: 'membership_id' });
